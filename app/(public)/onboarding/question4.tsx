...
export default function Question4() {
  ...
  // Big spacing: use xxl if present, else 2x xl; bottom = 2.5x
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }}>
      ...
      >
        {/* Header with extra bottom breathing room (2.5x) */}
      ...
      >
        <Pressable
          ...
          onPress={() => router.push('/(public)/onboarding/question5')}
          style={[
            styles.cta,
            {
              backgroundColor: theme.colors.text, // enabled color via token
              opacity: canContinue ? 1 : 0.45,     // disabled look
            },
          ]}
          accessibilityRole="button"
