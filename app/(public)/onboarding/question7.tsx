...
export default function Question7() {
  ...
  // bigPad = xxl if present, else 2x xl
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }}>
      ...
      >
        {/* Header with larger bottom spacing (2.5x) */}
        <View style={{ paddingTop: bigPad, paddingBottom: bigPad * 5.5 }}>
      ...
      >
        <Pressable
          ...
          onPress={() => router.push('/(public)/onboarding/question8')}
          style={[
            styles.cta,
            {
